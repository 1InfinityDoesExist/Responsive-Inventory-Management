...
<body>
	<center>
		...
		<form>
			...
			<table>
				<tr>
					<td>Customer Name</td>
					<td><input type="text" name="cname" placeholder= ${cn} size="25" readonly/></td>
				</tr>
				<tr>
					<td>Customer Address</td>
					<td><input type="text" name="cadd" placeholder=${ca} size="25" readonly></td>
				</tr>
				<tr>
					<td>Todays Date/Time</td>
					<td><input type="text" name="dt" value=${da} size="25" readonly></td>
				</tr>
			</table>
			<br>
	...
	public void jspDestroy() {
		try {
			...
			<table>
				<tr>
					<label>Product Name <input list="product" name="product" id="p" onkeyup="doSomething();" size="25" />
					</label>
				...
				<tr>
					<td></td>
					<td><a href="buying.jsp">Go For It</a></td>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="tp" id="textf"
						placeholder=${grand} size="25" readonly></td>
				</tr>
			</table>
			...
			<form action="ses" method="post" autocomplet="on">
				...
				<table>
					<tr>
						...
						<td><input type="text" name="cname"  id="cname"  placeholder = ${cn} class="form-control" value= ${cn }
							  size="25"
							readonly></td>
						</div>
					</tr>
					<tr>
						...
						<td><input type="text" name="cadd" class="form-control" placeholder = ${ca } value= ${ca }
							 size="25" readonly></td>
						</div>
					</tr>
					<tr>
